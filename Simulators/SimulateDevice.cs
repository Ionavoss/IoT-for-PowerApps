...
class Program
{
    ...
    private static readonly string connectionString = "Your-IoT-Device-Connection-String"; //"i.e. HostName=iothubname.azure-devices.net;DeviceId=device1;SharedAccessKey=testSASle99=ekf";
    ...
    private static async Task SendDeviceToCloudMessagesAsync()
    {
        ...
        while (true)
        {
            ...
            string messageString = $"{{\"temperature\":{temperature},\"humidity\":{humidity}}}";
